...
public class inscriptionServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        // recuperation des données du formulaire après clique sur le boutton s'inscriee
        // creer un objet de type utilisateur pour envoyer les données dans la bdd
        ...
        try {
            // envoyer les données dans la database
